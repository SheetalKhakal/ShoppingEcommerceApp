package com.sheetal.shoppingecommerceapp.adapters;
...
import com.sheetal.shoppingecommerceapp.databinding.ShopRowItemBinding;
...
public class ShopListAdapter extends ListAdapter<Product, ShopListAdapter.ShopViewHolder>
{
    ...
    public ShopViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ShopRowItemBinding shopRowBinding = ShopRowItemBinding.inflate(layoutInflater, parent, false);
    ...
    class ShopViewHolder extends RecyclerView.ViewHolder {
        ...
        ShopRowItemBinding shopRowBinding;

        public ShopViewHolder(ShopRowItemBinding binding) {
